    ...
    <div className='confirm-modal'>
      ...
      >
          ...
          <div className='cicm-colour'>
            ...
            <div className='cicm-change-out-color'>
              ...
              <div style={{paddingBottom: "17px"}}>
                <select className='acp-pallet-select'
        ...
        <div className='cicm-footer'>
          <div className='acp-delete-button' onClick={deleteColour}>
            <svg className="acp-delete-icon" width="12" height="14" viewBox="0 0 12 14" fill="none"
